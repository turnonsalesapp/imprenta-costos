...
export function Calculadora({
  ...
  const pts = useMemo(() => {
    ...
    return qs.map((cant) => {
      const c = calcular({ ...form, cantidad: cant, precioManual: "" }, cfg);
      return {
  ...
  const ptsMargen = useMemo(() => {
    ...
    return ms.map((mg) => {
      const c = calcular({ ...form, margen: mg, precioManual: "" }, cfg);
      return {
  ...
  const opcionesTamano = useMemo(() => {
    ...
    return TAMANOS_DIGITAL.map((t) => {
      ...
      const c = calcular({ ...form, tamano: t.id, capacidad: cap, precioManual: "" }, cfg);
    ...
    <div className="pr">
      ...
      <div className="grid">
        ...
        <div>
                    ...
                    <table>
                      <thead>
                        <tr>
                          ...
                          {verEstructura && <th className="ta-r">Costo total</th>}
                          {verEstructura && <th className="ta-r">Costo unit.</th>}
                          <th className="ta-r">Precio unit.</th>
                          <th className="ta-r">Venta total</th>
                          {verEstructura && <th className="ta-r">Ganancia</th>}
                        ...
                        {pts.map((p) => {
                          ...
                          return (
                            <tr key={p.cant} className="rw"
                              ...
                              {verEstructura && <td className="ta-r mono" style={{ color: "#767D76" }}>{usd(p.costoTotal)}</td>}
          ...
          {verEstructura && ptsMargen.length >= 1 && r.precioUnit > 0 ? (
            <section className="card">
              <div className="ch">
                      ...
                      {opcionesTamano.map((o) => {
                        ...
                        return (
                          <tr key={o.id} className="rw"
                            ...
                            {verEstructura && <td className="ta-r mono" style={{ color: "#767D76" }}>{o.entra ? usd(o.costoTotal) : "no entra"}</td>}
        ...
        <div className="tick">
          <div className="tk">
            ...
            {/* verEstructura: cálculo en cliente; ocultación UI del desglose,
                costo y utilidad. El precio de venta siempre se muestra. */}
            {verEstructura && (
              <>
                <div className="bar">
                  {r.lineas.map((l, i) => (
